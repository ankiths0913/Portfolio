...
function About() {
  return (
    <div  name="About" className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-16">
      ...
      <p>
        Hello, I'm Ankit, a aspiring Software developer with expertise in Java, JDBC, MySQL, and
        Foundational Knowledge in cloud computing. Seeking to contribute to cutting-edge technology
        Solution with a keen interest in AI, mobility, and analytics.  
      </p>
      <br />
      ...
      <span>
        ...
        [Institution], [Year] [Relevant Course], [Platform/Information], [Year]
      </span>
      <br/>
      <br/>
      <h1 className="text-green-600 font-semibold text-xl">
